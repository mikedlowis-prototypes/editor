...
struct {
    ...
    [SynKeyword]   = { "tide.colors.syntax.keyword",      INTEGER, { .num = 0x000E } },
    [SynOperator]  = { "tide.colors.syntax.operator",     INTEGER, { .num = 0x000E } },
    [SynPreProc]   = { "tide.colors.syntax.preprocessor", INTEGER, { .num = 0x000D } },
    [SynType]      = { "tide.colors.syntax.type",         INTEGER, { .num = 0x0009 } },
    [SynStatement] = { "tide.colors.syntax.statement",    INTEGER, { .num = 0x000E } },
